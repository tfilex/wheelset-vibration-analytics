...
8. RUL-specific предобучение CNN: `best_resnet18_rul.pth`.
9. Расширенные семейства моделей: `v3_rnn`, `v4_tcn`, `v5_odd`.
10. Автоматизация запусков: balanced runners и overnight runner.
11. Production-ready Streamlit-демо с реальным инференсом, выбором checkpoint и Docker-упаковкой.
