...
MLFLOW_EXPERIMENT = "XJTU_SY_RUL_ThreeModels_v2"
...
PREDS2_MODELS_DIR = os.path.join(MODELS_DIR, "preds_2")
...
FIGURES_BASE_DIR = "reports/figures/summary/train_three_models_2"
